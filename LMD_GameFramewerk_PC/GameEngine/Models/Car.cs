...
namespace LMD_GameFramewerk_PC.GameEngine.Models
{
	public class Car
	{
		...
		private void init(float x, float y)
		{
			...
			InfoBody while_1 = px.AddCircle(x - 150, y - 50, 30, 0, 0.4f, 0.4f, 0.4f, GResource.tex_circle);
			InfoBody while_2 = px.AddCircle(x + 150, y - 50, 30, 0, 0.4f, 0.4f, 0.4f, GResource.tex_circle);
